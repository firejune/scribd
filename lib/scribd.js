 ...
 * @param int limit : number of results to return (20 default, 1000 max)
 * @param int offset : number of start at (0 default, 1000 max)
 * @param string scope : scope of search, "new" or "hot"
 ...
 * @param int limit : number of results to return (20 default, 1000 max)
 * @param int offset : number of start at (1 default, 1000 max)
 * @param int category_id : a category ID to search documents in
 * @param string scope : scope of search, "popular" of "views" of "newest"
 * @return array of results with categories or subcategories
 */
Scribd.prototype.browse = function(callback, limit, offset, categoryId, scope) {
